...
ECorp's mission, task, approval, budget, and lease models remain internal. External protocols are
...
- ACP maps local client sessions and prompts to ECorp mission/run identities.
